...
{
    public partial class HRMODBContext : DbContext
    {

        public HRMODBContext()
        {

        }

        public HRMODBContext(DbContextOptions<HRMODBContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=DESKTOP-RFS50QE\\SERVER;Database=HRMODB;Trusted_Connection=True;");
            }
        }
