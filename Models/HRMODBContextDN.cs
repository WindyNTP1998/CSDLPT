...
{
    public partial class HRMODBContextDN : DbContext
    {

        public HRMODBContextDN() { }

        public HRMODBContextDN(DbContextOptions<HRMODBContextDN> options)
            : base(options)
        {
        }
        ...
        {
            optionsBuilder.UseSqlServer("Server=DESKTOP-RFS50QE\\CLIENT02;Database=HRMODB;Trusted_Connection=True;");
        }
